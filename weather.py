...
#title of our window
root.title("vathavaranam telusko")
...
#Enter you api key, copies from the OpenWeatherMap dashboard
    api_key = "3899950e5e90f19e35ecaa3a5536801c"  #sample API
...
Label(root,text="only main city names").pack() 
...
tfield.pack()
Label(root,text="PROJECT BY KARTHIK", font='Tahoma' , bg="lightblue").pack()
root.mainloop()